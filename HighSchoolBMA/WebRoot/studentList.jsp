   ...
   <c:forEach items="${list}" var="user">
       <tr>
        ...
        <td>${user.lastname}
                ...
                <td><a href="<%=basePath%>UserAction!authorizationStudent?id=${user.id}">authorization</a> </td>
       </tr>
      </c:forEach>
    ...
    <tr>
        ...
        <td><a href="<%=basePath%>/UserAction!authorizationStudent?id=${element.id}">authorization</a> </td>
    </tr>
</s:iterator>
</table>
